...
private:
	...
	const char* const noiseEffects[6] =
	{
		"OCEAN_NOISE",
		"RAINBOW_NOISE",
		"CLOUD_NOISE",
...
//		}
		...
		{
			delete effect; effect = new NoiseMatrixLedEffect<MATRIX, ledLine, width, height>(random(8, 30), OceanColors_p, random(10, 40));
		...
		{
			delete effect; effect = new NoiseMatrixLedEffect<MATRIX, ledLine, width, height>(random(8, 30), CloudColors_p, random(15, 40));
